...
class dsgrnDatabase:
  ...
  def full_inducibility (self, gene, bounds1, bounds2, max_gpi):
    ...
    MatchesDouble = frozenset(self.DoubleFPQuery(bounds1,bounds2).intersection(self.bistablemorsegraphindices)) #This includes bistability at lowest and highest nodes
    c = self.conn.cursor()
